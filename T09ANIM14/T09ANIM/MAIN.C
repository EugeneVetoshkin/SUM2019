...
INT WINAPI WinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, CHAR *CmdLine, INT ShawCmd )
{
  ...
  if (!RegisterClass(&wc))
  {
    MessageBox(NULL, "Oh Shit", "ERROR", MB_OK);
    return 0;                            
  }
  hWnd =
    CreateWindow(WND_CLASS_NAME, "here we go again", WS_OVERLAPPEDWINDOW,
      0, 0,
      1000, 1000,
  ...
  //EV5_AnimUnitAdd(EV5_UnitCityCreate());
  EV5_AnimUnitAdd(EV5_UnitCowCreate());
  EV5_AnimUnitAdd(EV5_UnitTextCreate());
