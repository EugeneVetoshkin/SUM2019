...
static VOID EV5_UnitInit( ev5UNIT_Text *Uni, ev5ANIM *Ani )
{
  ...
  hFnt = CreateFont(30, 0, 0, 0, FW_REGULAR, FALSE, FALSE,
...
{ 
  ...
  glListBase(102);
  len = sprintf(Buf, "Updated by BLIZZARD ENTERTAIMENT FPS: %.3f, primitives: %i, triangles: %i", Ani->FPS , EV5_RndCounterPrims, EV5_triangles);
