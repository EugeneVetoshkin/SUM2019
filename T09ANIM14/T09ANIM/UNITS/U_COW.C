...
static VOID EV5_UnitRender( ev5UNIT_Cow *Uni, ev5ANIM *Ani )
{
  MATR m;
    ...
    m = MatrMulMatr3(MatrScale(VecSet(EV5_Anim.JPov + 2, EV5_Anim.JPov + 2, EV5_Anim.JPov + 2)),
                     MatrMulMatr3( 
                       MatrRotateX( 90.0 * -EV5_Anim.JBut[0] + 90.0 * EV5_Anim.JBut[3]),
                       MatrRotateY( 90.0 * 2 * -EV5_Anim.JR),
                       MatrRotateZ( 45.0 * 2 * -EV5_Anim.JZ)),
                     MatrTranslate(VecSet(40 * -EV5_Anim.JY, 0,2 + 40 * EV5_Anim.JX)));
